...
console.log(`The best student with highest avg score is: ${JSON.stringify(bestStudent)} with avg score: ${currentHighestScore}`);

// Controller
function findBestStudent(students) {
    let bestStudent = students[0];
    let currentHighestScore = 0;
    for (const student of students) {  // dùng for of khi muốn truy cập từng value của array nhưng k muốn thay đổi giá trị của nó
